<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Decision.aspx.cs" Inherits="Starbucks.Decision" MasterPageFile="MasterPage.Master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
      ...
      <asp:Label ID="DecisionLable" runat="server" Font-Names="BookMan Old Style" Font-Size="24pt" ForeColor="BLUE"
        Style="z-index: 101; left: 45px; position: absolute; top: 100px" Text="Decide a location "></asp:Label>

    <asp:Label  CssClass="MessageStyle" ID="DecidelblMessage" runat="server" Font-Bold="True" Font-Names="BookMan Old Style" Font-Size="20pt" ForeColor="Green"></asp:Label>
    ...
    <br />  
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:Button ID="DecideButton" runat="server" Text="Decide" Width="100px" OnClick="Decide_Click" />
               
            </td>
            <td>
                <asp:Button ID="ClearButton" runat="server" Text="Cancel" Width="100px" OnClick="Clear_Click" /></td>
            <td class="auto-style1">
                <asp:Button ID="InsertButton" runat="server" Text="Insert" Width="100px" OnClick="InsertButton_Click" />
               
            </td>
            <td>
                <asp:Button ID="VisualizeButton" runat="server" Text="Visualize" Width="100px" OnClick="VisualizeButton_Click" /></td>
    ...
    <!-- <div id="GmapDivId"> -->
        ...
        <cc1:GMap ID="GMap1" runat="server" Height="1000px" Width="1000px" GZoom="9"   />
